# GET /api/v1/monitoring/threadpool Flow

## Entry Point

- `MonitoringController.getThreadPoolStatus()`
- `GET /api/v1/monitoring/threadpool`

## Flow

- `MonitoringController.getThreadPoolStatus()`가 `GET /api/v1/monitoring/threadpool`를 처리한다.
