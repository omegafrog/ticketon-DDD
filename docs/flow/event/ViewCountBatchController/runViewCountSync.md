# POST /api/v1/batch/viewcount-sync Flow

## Entry Point

- `ViewCountBatchController.runViewCountSync()`
- `POST /api/v1/batch/viewcount-sync`

## Flow

- `ViewCountBatchController.runViewCountSync()`가 `POST /api/v1/batch/viewcount-sync`를 처리한다.
