# POST /api/v1/events/list Flow

## Entry Point

- `EventQueryController.getEvents()`
- `POST /api/v1/events/list`

## Flow

- `EventQueryController.getEvents()`가 `POST /api/v1/events/list`를 처리한다.
...
- [Use Case](../../usecase/event/EventQueryController/getEvents.md)
