# POST /api/v1/test/cache-invalidation Flow

## Entry Point

- `CacheTestController.testCacheInvalidation()`
- `POST /api/v1/test/cache-invalidation`

## Flow

- `CacheTestController.testCacheInvalidation()`가 `POST /api/v1/test/cache-invalidation`를 처리한다.
