# PUT /api/v1/events/{eventId} Flow

## Entry Point

- `EventCommandController.updateEvent()`
- `PUT /api/v1/events/{eventId}`

## Flow

- `EventCommandController.updateEvent()`가 `PUT /api/v1/events/{eventId}`를 처리한다.
...
- [Troubleshooting](../../troubleshooting/event/EventCommandController/updateEvent.md)
