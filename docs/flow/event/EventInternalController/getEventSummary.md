# GET /internal/events/{eventId}/summary Flow

## Entry Point

- `EventInternalController.getEventSummary()`
- `GET /internal/events/{eventId}/summary`

## Flow

- `EventInternalController.getEventSummary()`가 `GET /internal/events/{eventId}/summary`를 처리한다.
