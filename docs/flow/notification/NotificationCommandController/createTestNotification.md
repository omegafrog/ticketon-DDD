# POST /api/v1/notifications/test Flow

## Entry Point

- `NotificationCommandController.createTestNotification()`
- `POST /api/v1/notifications/test`

## Flow

- `NotificationCommandController.createTestNotification()`가 `POST /api/v1/notifications/test`를 처리한다.
...
- [Use Case](../../usecase/notification/NotificationCommandController/createTestNotification.md)
