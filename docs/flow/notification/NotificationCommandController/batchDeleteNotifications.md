# POST /api/v1/notifications/batch-delete Flow

## Entry Point

- `NotificationCommandController.batchDeleteNotifications()`
- `POST /api/v1/notifications/batch-delete`

## Flow

- `NotificationCommandController.batchDeleteNotifications()`가 `POST /api/v1/notifications/batch-delete`를 처리한다.
