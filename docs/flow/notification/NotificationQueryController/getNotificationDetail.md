# GET /api/v1/notifications/{id} Flow

## Entry Point

- `NotificationQueryController.getNotificationDetail()`
- `GET /api/v1/notifications/{id}`

## Flow

- `NotificationQueryController.getNotificationDetail()`가 `GET /api/v1/notifications/{id}`를 처리한다.
