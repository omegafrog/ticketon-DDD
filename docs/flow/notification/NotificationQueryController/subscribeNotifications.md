# GET /api/v1/notifications/subscribe Flow

## Entry Point

- `NotificationQueryController.subscribeNotifications()`
- `GET /api/v1/notifications/subscribe`

## Flow

- `NotificationQueryController.subscribeNotifications()`가 `GET /api/v1/notifications/subscribe`를 처리한다.
...
- [Troubleshooting](../../troubleshooting/notification/NotificationQueryController/subscribeNotifications.md)
