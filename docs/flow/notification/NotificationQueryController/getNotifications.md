# GET /api/v1/notifications Flow

## Entry Point

- `NotificationQueryController.getNotifications()`
- `GET /api/v1/notifications`

## Flow

- `NotificationQueryController.getNotifications()`가 `GET /api/v1/notifications`를 처리한다.
