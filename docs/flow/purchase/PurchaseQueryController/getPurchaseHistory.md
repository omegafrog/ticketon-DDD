# GET /api/v1/purchases/history Flow

## Entry Point

- `PurchaseQueryController.getPurchaseHistory()`
- `GET /api/v1/purchases/history`

## Flow

- `PurchaseQueryController.getPurchaseHistory()`가 `GET /api/v1/purchases/history`를 처리한다.
...
- [Troubleshooting](../../troubleshooting/purchase/PurchaseQueryController/getPurchaseHistory.md)
