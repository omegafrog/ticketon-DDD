# POST /api/v1/payments/{paymentKey}/cancel Flow

## Entry Point

- `PurchaseCommandController.cancelPayment()`
- `POST /api/v1/payments/{paymentKey}/cancel`

## Flow

- `PurchaseCommandController.cancelPayment()`가 `POST /api/v1/payments/{paymentKey}/cancel`를 처리한다.
