...
- `RefundCommandController.processManagerRefund()`
- `POST /api/v1/refunds/manager/single`

## Flow

- `RefundCommandController.processManagerRefund()`가 `POST /api/v1/refunds/manager/single`를 처리한다.
...
- [Use Case](../../usecase/purchase/RefundCommandController/processManagerRefund.md)
