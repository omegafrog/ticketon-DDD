# GET /api/test/purchase/optimized/{eventId} Flow

## Entry Point

- `PurchaseTestController.testOptimizedQuery()`
- `GET /api/test/purchase/optimized/{eventId}`

## Flow

- `PurchaseTestController.testOptimizedQuery()`가 `GET /api/test/purchase/optimized/{eventId}`를 처리한다.
...
- [Trouble](../../trouble/purchase/PurchaseTestController/testOptimizedQuery.md)
