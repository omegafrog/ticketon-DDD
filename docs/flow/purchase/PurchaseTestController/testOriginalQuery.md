# GET /api/test/purchase/original/{eventId} Flow

## Entry Point

- `PurchaseTestController.testOriginalQuery()`
- `GET /api/test/purchase/original/{eventId}`

## Flow

- `PurchaseTestController.testOriginalQuery()`가 `GET /api/test/purchase/original/{eventId}`를 처리한다.
...
- [Use Case](../../usecase/purchase/PurchaseTestController/testOriginalQuery.md)
