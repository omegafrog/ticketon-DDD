# GET /api/v1/payments/confirm/{purchaseId}/status Flow

## Entry Point

- `PurchaseConfirmQueryController.getConfirmStatus()`
- `GET /api/v1/payments/confirm/{purchaseId}/status`

## Flow

- `PurchaseConfirmQueryController.getConfirmStatus()`가 `GET /api/v1/payments/confirm/{purchaseId}/status`를 처리한다.
