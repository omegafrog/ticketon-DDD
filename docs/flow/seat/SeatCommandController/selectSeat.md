# POST /api/v1/events/{event-id}/seats Flow

## Entry Point

- `SeatCommandController.selectSeat()`
- `POST /api/v1/events/{event-id}/seats`

## Flow

- `SeatCommandController.selectSeat()`가 `POST /api/v1/events/{event-id}/seats`를 처리한다.
...
- [Use Case](../../usecase/seat/SeatCommandController/selectSeat.md)
