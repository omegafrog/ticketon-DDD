# GET /api/v1/auth/social/{socialLoginType} Flow

## Entry Point

- `SecurityController.request()`
- `GET /api/v1/auth/social/{socialLoginType}`

## Flow

- `SecurityController.request()`가 `GET /api/v1/auth/social/{socialLoginType}`를 처리한다.
...
- [Use Case](../../usecase/auth/SecurityController/request.md)
