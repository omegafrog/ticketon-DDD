# GET /api/v1/auth/social/{socialLoginType}/callback Flow

## Entry Point

- `SecurityController.callback()`
- `GET /api/v1/auth/social/{socialLoginType}/callback`

## Flow

- `SecurityController.callback()`가 `GET /api/v1/auth/social/{socialLoginType}/callback`를 처리한다.
...
- [Use Case](../../usecase/auth/SecurityController/callback.md)
