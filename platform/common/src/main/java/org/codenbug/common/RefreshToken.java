...
public class RefreshToken {
	...
	/**
	 * verify the refreshToken to ensure it matches the given userId and was issued
	 * after the date
	 * 
	...
	public void verify(String accessTokenJti, SecretKey secretKey) {
		Jwts.parser().verifyWith(secretKey).require("access-jti", accessTokenJti).build().parse(value);
	}
