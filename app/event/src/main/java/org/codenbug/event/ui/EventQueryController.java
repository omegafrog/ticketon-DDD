...
public class EventQueryController {
    ...
    public ResponseEntity<RsData<Page<EventListProjection>>> getEvents(
        ...
        Pageable pageable) {
        Page<EventListProjection> eventList = eventViewService.getEventSearchResult(keyword, filter,
            pageable);
    ...
    @GetMapping("/{id}")
    public ResponseEntity<RsData<EventListProjection>> getEvent(
    ...
    public ResponseEntity<RsData<Page<EventListProjection>>> getManagerEvents(Pageable pageable) {
        ...
        Page<EventListProjection> events = eventViewRepository.findManagerEventList(userId,
            pageable);
