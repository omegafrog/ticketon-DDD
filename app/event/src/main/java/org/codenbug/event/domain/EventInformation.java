...
public class EventInformation {
    ...
    public EventInformation(String title, String thumbnailUrl, Integer ageLimit,
        String restrictions,
        String description,
        LocalDateTime bookingStart, LocalDateTime bookingEnd, LocalDateTime eventStart,
        LocalDateTime eventEnd,
        Boolean seatSelectable, int minPrice, int maxPrice, EventStatus status,
    ...
    public EventInformation(NewEventRequest request) {
        this(request.getTitle(), request.getThumbnailUrl(),
            ...
            request.getDescription(), request.getBookingStart(), request.getBookingEnd(),
