...
public class NotificationDomainService {
    ...
    public Notification createNotification(String userId, NotificationType type, String title, String content, String targetUrl) {
        UserId userIdVO = new UserId(userId);
        NotificationContent notificationContent = new NotificationContent(title, content, targetUrl);
        
        return new Notification(userIdVO, type, notificationContent);
    }

    public Notification createNotification(String userId, NotificationType type, String title, String content) {
        return createNotification(userId, type, title, content, null);
    }

    public Notification createLegacyNotification(String userId, NotificationType type, String content) {
