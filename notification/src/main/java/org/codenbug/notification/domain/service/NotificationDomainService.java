...
public class NotificationDomainService {
    ...
    public Notification createNotification(String userId, NotificationType type, String title,
        ...
        return createNotification(userId, type, title, content, targetUrl, null);
    }

    public Notification createNotification(String userId, NotificationType type, String title,
            String content, String targetUrl, String sourceKey) {
        UserId userIdVO = new UserId(userId);
        NotificationContent notificationContent =
                new NotificationContent(title, content, targetUrl);

        return new Notification(userIdVO, type, notificationContent, sourceKey);
    }
