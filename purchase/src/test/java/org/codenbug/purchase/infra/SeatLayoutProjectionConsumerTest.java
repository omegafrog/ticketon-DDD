...
public class SeatLayoutProjectionConsumerTest {
    ...
    @BeforeEach
    void setUp() {
        seatLayoutProjectionConsumer = new SeatLayoutProjectionConsumer(seatLayoutProjectionRepository);
    }
    ...
    void testHandleSeatLayoutCreated_ShouldCreateAndSaveSeatLayoutProjection() {
        ...
        SeatLayoutCreatedEvent event = new SeatLayoutCreatedEvent(
        ...
        ArgumentCaptor<SeatLayoutProjection> projectionCaptor = ArgumentCaptor.forClass(SeatLayoutProjection.class);
        ...
        assertAll("SeatLayoutProjection 필드 검증",
            ...
            () -> assertEquals(locationName, savedProjection.getLocationName(), "위치명이 일치해야 합니다"),
        ...
        assertTrue(savedSeats.stream().anyMatch(seat -> 
            "seat-1".equals(seat.getSeatId()) && 
            "A-01".equals(seat.getSignature()) && 
            seat.getAmount() == 50000 && 
            "VIP".equals(seat.getGrade())
        ), "VIP 좌석 정보가 정확해야 합니다");
        
        assertTrue(savedSeats.stream().anyMatch(seat -> 
            "seat-3".equals(seat.getSeatId()) && 
            "B-01".equals(seat.getSignature()) && 
            seat.getAmount() == 30000 && 
