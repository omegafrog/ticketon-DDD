...
public class TossPaymentPgApiService implements PGApiService {
  ...
  public TossPaymentPgApiService(@Qualifier("purchaseExternalRestTemplate") RestTemplate restTemplate,
   ...
   */
  @Override
  public PaymentConfirmationInfo confirmPayment(String paymentKey, String orderId, Integer amount) {
  ...
  public PaymentConfirmationInfo confirmPayment(String paymentKey, String orderId, Integer amount,
    ...
    Map<String, Object> body = Map.of(
        ...
        "orderId", orderId,
        "amount", amount);
    return postToToss(url, body, ConfirmedPaymentInfo.class, idempotencyKey).toDomain();
  }
   ...
   */
  @Override
  public PaymentCancellationInfo cancelPayment(String paymentKey, String cancelReason) {
    return cancelPayment(paymentKey, cancelReason, null);
  }

  @Override
  public PaymentCancellationInfo cancelPayment(String paymentKey, String cancelReason, String idempotencyKey) {
    String url = tossApiUrl + "/" + paymentKey + "/cancel";
    Map<String, Object> body = Map.of("cancelReason", cancelReason);
    return postToToss(url, body, CanceledPaymentInfo.class, idempotencyKey).toDomain();
  }
