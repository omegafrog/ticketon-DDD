...
public RedisLockServiceImpl(@Qualifier("simpleRedisTemplate") RedisTemplate<String, String> redisTemplate, RedisKeyScanner redisKeyScanner) {
	 ...
	 */
	@Override
	public List<String> getLockedSeatIdsByUserId(String userId) {
		Set<String> keys = redisKeyScanner.scanKeys(PREFIX + userId + ":*");
		if (keys == null || keys.isEmpty()) {
