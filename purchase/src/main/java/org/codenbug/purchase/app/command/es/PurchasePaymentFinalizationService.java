...
import org.codenbug.purchase.ui.response.ConfirmPaymentResponse;
...
public class PurchasePaymentFinalizationService {
  ...
  public ConfirmPaymentResponse finalizePayment(PurchaseId purchaseId, PaymentConfirmationInfo paymentInfo,
      String userId) {
    ...
    return new ConfirmPaymentResponse(paymentInfo.getPaymentKey(), paymentInfo.getOrderId(),
        ...
        localDateTime, new ConfirmPaymentResponse.Receipt(paymentInfo.getReceiptUrl()));
  }
}
